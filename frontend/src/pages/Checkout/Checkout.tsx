...
const content = (
  <div className='w-72'>
    <ul className='list-disc pl-4'>
      <li>Kiểm tra Đơn hàng trước khi thanh toán.</li>
      ...
      <li>
        Điều kiện đổi trả: Đơn hàng còn nguyên vẹn, chưa sử dụng, chưa bóc hộp và còn mới 100%. Giữ phiếu mua hàng.
      </li>
      ...
      <li>Không đổi trả nếu Đơn hàng không còn nguyên vẹn hoặc là quà tặng.</li>
    </ul>
  </div>
)
const Checkout = () => {
      ...
      <div className='detail gap-y-10 lg:gap-y-0 lg:flex-row flex flex-col justify-between mt-6'>
        <form id='form_info_checkout' className='left w-full lg:w-[60%]'>
          <div className='title flex justify-between items-center px-5 mb-[7px] '>
            <div>
              <h2 className='text-sm font-bold'>Thông tin đón bé</h2>
            </div>
          </div>
