...
const MyOrder = () => {
  ...
  const listReason: string[] = [
    'Không muốn đặt đơn hàng này nữa.',
    'Đơn hàng không đúng mô tả trên trang web.',

    ' không còn cần thiết.',
    'Thay đổi ý định .',
    'Gặp vấn đề tài chính không thể tiếp tục.',
    'Đặt đơn nhầm.'
  ]
  ...
  return (
    <>
      ...
      <div className='layout-container w-full'>
        <h2 className='title text-[#333] text-lg font-medium mb-5'>Lịch sử</h2>
