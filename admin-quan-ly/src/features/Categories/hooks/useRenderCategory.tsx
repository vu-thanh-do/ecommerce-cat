    ...
    },
    {
      ...
      render: (_: string, category: any) => {
        const image = category?.products[0]?.images[0]?.url
          ...
          : 'http://localhost:5173/inner_image_01.png'
        return (
      ...
      render: (_: string, category: ICategory) => {
        if (!isDeleted) {
          return (
            <div className='flex items-center justify-center'>
              <Space size='middle'>
                ...
                <Tooltip title='Xóa Giống mèo'>
                  <Popconfirm
                    title='Bạn có muốn xóa Giống mèo này?'
                    description='Bạn chắc chắn muốn xóa Giống mèo này?'
          ...
          return (
            <div className='flex items-center justify-center'>
              <Space size='middle'>
                <Tooltip title='Khôi phục Giống mèo này'>
                  <Popconfirm
                    title='Bạn muốn khôi phục lại Giống mèo này?'
                    description='Bạn thực sự muốn khôi phục lại Giống mèo này?'
                ...
                <Tooltip title='Xóa vĩnh viễn Giống mèo này'>
                  <Popconfirm
                    title='Bạn có muốn xóa VĨNH VIỄN Giống mèo này?'
